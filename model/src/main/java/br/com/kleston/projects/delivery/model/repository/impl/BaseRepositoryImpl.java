...
import br.com.kleston.projects.delivery.model.repository.BaseRespository;
...
public class BaseRepositoryImpl<T extends Table, E extends BaseDTO> implements BaseRespository<E> {
    ...
    public void delete(E record) {
        this.dsl.delete( this.table ).where(this.table.getIdentity().getField().getName() + " = " + record.getId());
    }
}